...
detect_mac80211() {
	...
	for _dev in /sys/class/ieee80211/*; do
		...
		uci -q batch <<-EOF
			...
			set wireless.radio${devidx}.distance=2000
			...
			set wireless.default_radio${devidx}.ssid=GLORIA${ssid_5ghz}-$(cat /sys/class/ieee80211/${dev}/macaddress | awk -F ":" '{print $4""$5""$6 }'| tr a-z A-Z)
